...
use App\Filament\Resources\VideotronResource\Pages;
use App\Filament\Resources\VideotronResource\RelationManagers;
...
class VideotronResource extends Resource
{
    protected static ?string $model = Videotron::class;
            ...
            ->schema([
                ...
                Forms\Components\FileUpload::make('images')
                    ...
                    ->getUploadedFileNameForStorageUsing(
                        fn (TemporaryUploadedFile $file): string => 'img/videotron/' . now()->timestamp . '-' . str_replace(' ', '-', $file->getClientOriginalName())
                    )
                    ->columnSpanFull(),
                ...
                ->required()
                    ...
                    ->afterStateUpdated(function ($state, $record) {
                        if ($state) {
                            Videotron::where('id', '!=', $record?->id)->update(['is_featured' => false]);
                        }
                    }),
    ...
    {
        return [
            'index' => Pages\ListVideotrons::route('/'),
            'create' => Pages\CreateVideotron::route('/create'),
            'edit' => Pages\EditVideotron::route('/{record}/edit'),
        ];
    }
}

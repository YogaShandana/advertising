            ...
            ->schema([
                ...
                Forms\Components\FileUpload::make('images')
                    ...
                    ->getUploadedFileNameForStorageUsing(
                        fn (TemporaryUploadedFile $file): string => 'img/billboard/' . now()->timestamp . '-' . str_replace(' ', '-', $file->getClientOriginalName())
                    )
                    ->columnSpanFull(),
                ...
                Forms\Components\Toggle::make('is_featured')
                    ...
                    ->afterStateUpdated(function ($state, $record) {
                        if ($state) {
                            Billboard::where('id', '!=', $record?->id)->update(['is_featured' => false]);
                        }
                    }),

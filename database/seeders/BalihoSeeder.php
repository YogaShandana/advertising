...
class BalihoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $coordinates = [
            '10. SINGARAJA' => '-8.1120, 115.0882', // Singaraja
            '11. GIANYAR' => '-8.5420, 115.3280', // Gianyar
            '12. JEMBRANA' => '-8.3760, 114.6710', // Negara, Jembrana
            '7. MENGWI' => '-8.5667, 115.1667', // Mengwi, Badung
            '8. DENPASAR' => '-8.6705, 115.2126', // Denpasar
            '9. TABANAN' => '-8.5442, 115.1219', // Tabanan
        ];

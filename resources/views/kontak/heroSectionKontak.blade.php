@php
    $heroTitle = $heroSection?->judul ?? 'Hubungi Kami';
    $heroDesc = $heroSection?->deskripsi ?? 'Kami siap membantu kebutuhan promosi bisnis Anda. Hubungi kami untuk konsultasi dan penawaran terbaik.';
    $heroImage = $heroSection?->gambar ? asset('storage/' . $heroSection->gambar) : asset('storage/img/herosection/kontak.jpg');
@endphp

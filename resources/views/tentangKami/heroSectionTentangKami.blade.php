@php
    $heroTitle = $heroSection?->judul ?? 'Tentang Kami';
    $heroDesc = $heroSection?->deskripsi ?? 'Tri Bhakti Advertising adalah perusahaan periklanan luar ruang terkemuka yang berdedikasi untuk membantu bisnis Anda tumbuh melalui solusi promosi yang efektif dan inovatif.';
    $heroImage = $heroSection?->gambar ? asset('storage/' . $heroSection->gambar) : asset('storage/img/herosection/tentangkami.webp');
@endphp
